  ...
  return (
    ...
    >
      <div
        ...
        ${isSelected ? "min-h-[180px] md:min-h-[160px] lg:min-h-[120px] sm:min-h-[120px]" : "min-h-[0px]"}`}
      >
        ...
        <div
          className={`absolute text-md md:text-lg bottom-0 z-1 md:bottom-4 duration-500 ${isSelected ? "opacity-100" : "opacity-0"}`}
        >
